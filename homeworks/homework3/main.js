...
let texts = ['asd','asd','asd','asd','asd','asd','asd','asd','asd','asd','asd','asd','asd','asd','asd','asd','asd','asd','asd','asd'];
for (let i=0; i<10; i++)
{
...
for (let i=0; i<10; i++)
{
    document.write(`<div>${texts[i]+i}</div>`);
}
...
while (i<20)
{
    document.write(`<h1>${texts[i]+i}</h1>`);
    i++;
}
//------------------------------------------------------------
